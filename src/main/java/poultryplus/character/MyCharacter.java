...
import poultryplus.cards.Strike;
import poultryplus.cards.Takeoff;

import java.util.ArrayList;

import static poultryplus.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add("poultryplus:HookedBeak");
