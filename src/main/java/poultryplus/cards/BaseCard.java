...
import poultryplus.BasicMod;
import poultryplus.util.CardStats;
import poultryplus.util.TriFunction;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

import static poultryplus.util.GeneralUtils.removePrefix;
import static poultryplus.util.TextureLoader.getCardTextureString;
